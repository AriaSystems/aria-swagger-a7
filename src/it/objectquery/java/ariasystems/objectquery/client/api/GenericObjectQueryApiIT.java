 ...
 *
 */
public class GenericObjectQueryApiIT extends BaseObjectQueryApiIT {
	private static final String PackageClientApi = "ariasystems.objectquery.client.api";
	private static final String PackageClientModel = "ariasystems.objectquery.client.model";
	...
	private static final Logger logger = LoggerFactory.getLogger(GenericObjectQueryApiIT.class);
	...
	private Set<Class<?>> initializeApiClasses() {
		...
		logger.info("adding {} A7 classes", apiClasses.size());
		return apiClasses;
	}
	 ...
	 * successfully invoke its target Api on the QU system. This test ensures that
